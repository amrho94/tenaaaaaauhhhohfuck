...
return function(tenacity, adapter)
 ...
 module=tenacity:Module('Vision', {Name='CuteVisuals',DisplayName='Dream Particles',Tooltip='Floating pink hearts, drifting dots, pastel bursts and rainbow celebrations. Ported from CuteVisuals.java.',Function=function(enabled)
  clear()
  if enabled then
